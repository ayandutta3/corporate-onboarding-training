...
export const SUGGESTED_QUERIES = [
  ...
  {
    title: 'Production Incident Response & SEV-1',
    query: 'What is the required SLA for acknowledging SEV-1 production incidents, and who are the designated escalation point-of-contacts?',
...
export const INITIAL_DOCUMENTS: UploadedDoc[] = [
  {
    ...
    mode: 'hybrid',
    // removed: 'Corporate Finance & Ops',
    uploadedBy: 'David Chen',
    timestamp: '2026-07-28 14:22',
    chunksCount: 142,
    status: 'completed',
    vectordocument_id: 'chroma-col-fin-101',
  ...
  },
  {
    ...
    mode: 'vector',
    // removed: 'Core Architecture',
    uploadedBy: 'Marcus Vance',
    timestamp: '2026-07-29 09:15',
    chunksCount: 88,
    status: 'completed',
    vectordocument_id: 'chroma-col-eng-102',
  ...
  },
  {
    ...
    fileType: 'application/pdf',
    mode: 'hybrid',
    // removed: 'People & Culture',
    uploadedBy: 'Elena Rostova',
    timestamp: '2026-07-30 11:40',
    chunksCount: 210,
    status: 'completed',
    vectordocument_id: 'chroma-col-hr-103',
    embeddingModel: 'text-embedding-3-large',
  },
  {
    document_id: 'doc-104',
    ...
    fileType: 'application/pdf',
    mode: 'hybrid',
    // removed: 'Global Infrastructure & IT',
    uploadedBy: 'Sarah Connor',
    timestamp: '2026-07-31 16:05',
    chunksCount: 94,
    status: 'completed',
    vectordocument_id: 'chroma-col-it-104',
    embeddingModel: 'text-embedding-3-large',
  },
];
...
* Travel costing over **$1,500 USD** total requires prior written sign-off from your Department VP and Finance Manager via Jira Ticket \`FIN-TRAVEL-REQ\`.`;
    ...
    citations = [
      {
        document_id: 'cit-1',
        document_name: 'Global Travel & Expense Policy Q3 2026',
        file_type: 'Global_Travel_and_Expense_Policy_Q3_2026.pdf',
        // removed: 'Corporate Finance & Ops',
        // removed: isHybrid ? 0.978 : 0.912,
        // removed: 'Section 3.2: Itemized receipts are required for all transactions >= $25.00 USD. Per diem rate for domestic standard cities is $85/day split across breakfast ($20), lunch ($25), dinner ($40).',
        page_number: 14,
        chunkId: 'chk-fin-089',
        // removed: 'David Chen',
      },
      {
        document_id: 'cit-2',
        document_name: 'Executive Financial Delegation Matrix',
        file_type: 'Finance_Delegation_Matrix_2026.xlsx',
        // removed: 'Corporate Finance & Ops',
        // removed: isHybrid ? 0.945 : 0.880,
        // removed: 'Level 2 Approvals: Travel expenditure above $1,500 requires dual authorization from VP level and Corporate Finance Director before booking flights.',
        page_number: 2,
        chunkId: 'chk-fin-012',
        // removed: 'Financial Operations Committee',
      },
    ];
...
* Run \`aws-vault exec dev-sandbox -- aws sts get-caller-identity\` to verify local security tokens. Sandbox environments automatically auto-terminate unutilized resources after 8 hours of inactivity.`;
    ...
    citations = [
      {
        document_id: 'cit-3',
        document_name: 'Engineering Security & Developer Handbook',
        file_type: 'Engineering_Security_and_SSO_Handbook_v4.md',
        // removed: 'Core Architecture',
        // removed: isHybrid ? 0.985 : 0.925,
        // removed: 'Developer Sandbox Provisioning: All local dev environments must run Docker Desktop v4.28+ with hardware-backed SSH key signing via YubiKey. AWS dev sandbox keys rotate every 12 hours.',
        page_number: 5,
        chunkId: 'chk-eng-044',
        // removed: 'Marcus Vance',
      },
      {
        document_id: 'cit-4',
        document_name: 'Zero Trust Network Architecture Whitepaper',
        file_type: 'Zero_Trust_Architecture_v2.pdf',
        // removed: 'Global Infrastructure & IT',
        // removed: isHybrid ? 0.910 : 0.865,
        // removed: 'Access Control: Engineering SSH access requires short-lived certificates issued by HashiCorp Vault CA upon successful WebAuthn MFA prompt.',
        page_number: 11,
        chunkId: 'chk-it-102',
        // removed: 'Sarah Connor',
      },
    ];
...
* **Secondary Caregiver:** **12 weeks** of 100% paid parental leave.`;
    ...
    citations = [
      {
        document_id: 'cit-5',
        document_name: 'Comprehensive HR Benefits Guide 2026',
        file_type: 'Comprehensive_HR_Benefits_Guide_2026.pdf',
        // removed: 'People & Culture',
        // removed: isHybrid ? 0.991 : 0.938,
        // removed: 'Section 4.1 Dental Care: Delta Dental Premier Plan provides 100% coverage for Class I preventive care, 80% for Class II basic services, 50% for Class III major services up to $3,500 annual limit.',
        page_number: 22,
        chunkId: 'chk-hr-112',
        // removed: 'Elena Rostova',
      },
    ];
  } else {
...
* Reach out to your department manager or IT Service Desk via Slack \`#help-onboarding\` if further specific clarification is needed.`;
    ...
    citations = [
      {
        document_id: 'cit-gen-1',
        document_name: 'Enterprise Policy & Operational Guidelines',
        file_type: 'Enterprise_Policy_Framework_2026.pdf',
        // removed: 'Global Infrastructure & IT',
        // removed: isHybrid ? 0.952 : 0.890,
        // removed: `Direct excerpt matching user inquiry '${query.slice(0, 40)}...': All employees must abide by standard operational risk frameworks and consult department lead for policy exceptions.`,
        page_number: 3,
        chunkId: 'chk-gen-001',
